...
function report (auction) {
  ...
  const maxPrice = auction.maxPrice.toFixed(6)
  const maxPriceUSD = auction.maxPriceUSD.toFixed(2)
  const minPrice = auction.minPrice.toFixed(6)
  const minPriceUSD = auction.minPriceUSD.toFixed(2)
  const nextPrice = (minPrice * 2).toFixed(6)
  const nextPriceUSD = (minPriceUSD * 2).toFixed(2)
